...
interface TickingRebarEntity {
    ...
    companion object : Listener {
        ...
        private val tickingEntities = IdentityHashMap<TickingRebarEntity, TickingEntityData>()
        ...
        fun isTicking(entity: RebarEntity<*>?): Boolean {
            return entity is TickingRebarEntity && tickingEntities[entity]?.job?.isActive == true
        }

        @JvmSynthetic
        internal fun stopTicking(entity: TickingRebarEntity) {
