 ...
 * @see io.github.pylonmc.rebar.block.interfaces.GhostBlockHolderRebarBlock
 */
interface RebarMultiblock {
     ...
     *
     * This is **not** called when the multiblock itself is unloaded, use [io.github.pylonmc.rebar.block.interfaces.UnloadRebarBlockHandler] for that.
     *
