...
interface TickingRebarBlock {
    ...
    companion object : Listener {
        ...
        private val tickingBlocks = IdentityHashMap<TickingRebarBlock, TickingBlockData>()
        ...
        fun isTicking(block: RebarBlock?): Boolean {
            return block is TickingRebarBlock && tickingBlocks[block]?.job?.isActive == true
        }

        @JvmSynthetic
        internal fun stopTicking(block: TickingRebarBlock) {
