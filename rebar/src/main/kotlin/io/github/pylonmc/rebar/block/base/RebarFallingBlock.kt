...
interface RebarFallingBlock {
     ...
     */
    fun onItemDrop(event: EntityDropItemEvent, entity: RebarFallingBlockEntity) = RebarRegistry.ITEMS[(this as RebarBlock).key]?.createNewItemStack()
    ...
    class RebarFallingBlockEntity : RebarEntity<FallingBlock> {
        ...
        fun fallbackItem() : ItemStack? {
            return this.entity.persistentDataContainer.get(FALLBACK_ITEM, RebarSerializers.ITEM_STACK) ?: RebarRegistry.ITEMS[blockSchema.key]?.createNewItemStack()
        }
    }
