 ...
 *
 * Most fluid blocks can use [FluidBufferRebarBlock] or [FluidTankRebarBlock] instead.
 *
 ...
 */
interface FluidRebarBlock : EntityHolderRebarBlock, BlockBreakRebarBlockHandler {
